 ...
 */
final class Version20210920080742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE houses ADD categories VARCHAR(255) NOT NULL, ADD list_id_equipements LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', DROP ID_category, CHANGE listID_activities listID_activities LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE listID_tags listID_tags LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE listID_pics listID_pics LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE houses ADD ID_category INT DEFAULT NULL, DROP categories, DROP list_id_equipements, CHANGE listID_activities listID_activities VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE listID_tags listID_tags VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE listID_pics listID_pics VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
